...
# =====================================================================
# EVOLUTION SEARCH CONFIGURATION (Targeting Viscous Time Lag)
# =====================================================================
flare_gps = 1242460000  # GPS time of the detected X-ray flare
duration = 300          # Duration of each analysis window (seconds)

# Delay array in minutes: scanning from 0 to 120 minutes post-flare
delays_minutes = list(range(0, 125, 5))

# TVERC "Golden Window" frequency range for Cygnus X-1
f_target_min = 760
f_target_max = 770

def run_evolution_search():
    print(f"\n--- LAUNCHING TVERC EVOLUTION SWEEP (V4.0) ---")
    ...
    if len(valid_delays) > 1:
        ...
        # Plotting the evolution line (Markers kept as simple circles, no stars)
        ...
        plt.title('TVERC TWILIGHT HUM TIME EVOLUTION (Cygnus X-1)\n'
